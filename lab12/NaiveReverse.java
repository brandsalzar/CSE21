...
public class NaiveReverse {
	...
	public String reverse6(String s) {
		//return "abcdefg ";
		return(s.substring(5, 6) + s.substring(4, 5) +s.substring(3, 4) +s.substring(2, 3)+s.substring(1, 2)+s.substring(0, 1));//added
	...
	public String reverse8 (String s) {
		return(s.substring(7,8)+s.substring(6,7)+s.substring(5, 6) + s.substring(4, 5) +s.substring(3, 4) +s.substring(2, 3)+s.substring(1, 2)+s.substring(0, 1));//added
		}
	public String reverse9 (String s) {
		String partial = reverse8(s.substring(0, 8));
		String firstLetter = s.substring(8, 9);
		return (firstLetter + partial);
		}
	
	public static void main(String[] args) {
		NaiveReverse s = new NaiveReverse();
		System.out.print(s.reverse9("confident"));
	}
}
*/