...
public class ShopArr {
	...
	// Initialize method
	private void init(int max) { //constructor
	...
	public ShopArr(int max) {//constructor
		init(max);// Fill-in Code
	}
	...
	private double calcSubTotal() {//accesor
		double amount = 0;
		for(int i = 0; i<cheese.length; i++)
	...
	public void run() {
		...
		System.out.println("Random num is "+ free);// comment it after
		if (free != 0)
